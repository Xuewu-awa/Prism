...
/// <summary>
/// 通过 Win32 PlaySound 播放/停止 WAV 音频（零依赖，仅 Windows）。
/// </summary>
public static class Win32PlaySound
{
    ...
    public static void PlayFile(string wavPath) => PlaySound(wavPath, IntPtr.Zero, SndFilename | SndAsync);

    public static void Stop() => PlaySound(null, IntPtr.Zero, SndPurge);
}
